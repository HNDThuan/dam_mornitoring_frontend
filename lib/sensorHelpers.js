...
export const SEVERITY_MAP = {
  CRITICAL: { label: 'NGUY CẤP', level: 'danger', icon: '🔴', priority: 3 },
  ALERT: { label: 'BÁO ĐỘNG', level: 'danger', icon: '🟠', priority: 2 },
  WARNING: { label: 'CẦN CHÚ Ý', level: 'warning', icon: '🟡', priority: 1 },
  NORMAL: { label: 'AN TOÀN', level: 'safe', icon: '🟢', priority: 0 },
}
